...
| [qlik-dp-to-semantic-view](qlik-dp-to-semantic-view/) | [cleveranjos](https://github.com/cleveranjos) | Convert a Qlik Talend Cloud Data Product into a Snowflake Semantic View, carrying governed metadata (descriptions, glossary definitions, relationships, trust score) into comments, metrics and relationships. Requires the Qlik MCP server and Snowflake SQL access. |
